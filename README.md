# AKS 역사지식 고도서 한문 원문·한글 번역 공개 스냅샷

한국학중앙연구원 역사지식 시스템의 고도서 본문 텍스트를 수집하고, 한문 원문을 기준으로 한글 번역·독음·의미 요약을 붙인 공개용 Markdown 스냅샷입니다.
...
- 출처명: 한국학중앙연구원 역사지식 고도서 본문텍스트 서명별 목록
...
AKS 역사지식, 한국학중앙연구원, 고도서, 한문 원문, 한문 번역, 한국어 번역, 독음, 조선시대 문헌, 디지털 인문학, 지식 그래프, Korean classics, Hanmun translation, Korean history, digital humanities.
